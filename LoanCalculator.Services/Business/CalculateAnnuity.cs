    ...
    public class CalculateAnnuity
    {
                                                            ...
                                                            LoanDetails scheduleInputs, bool calculateServiceFeeTotal, double principalServiceFee, double loanAmountCalc)
        {
            ...
            try
            {
                ...
                //double firstRegularInterestPayment = currentPrincipal * regularInterestRate;
                //double firstInterestPaymentPaid = currentPrincipal * firstPeriodInterestRate;
                ...
                do
                {
                    ...
                    {
                        sbTracing.AppendLine("Inside CalculateAnnuity class, and CalcateAnnuityWithLongerFirstPeriod() method. Calling method : PeriodicInterestAmount.CalculateInterestWithTier(scheduleInputs, scheduleInputs.InputRecords[i - 1].DateIn, scheduleInputs.InputRecords[i].DateIn, scheduleInputs.InputRecords[0].DateIn, currentPrincipal, false);");
