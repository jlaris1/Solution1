...
{
    public class CreateScheduleForBankMethod
    {
        /// <summary>
        /// Name : Sparsh Agarwal
        /// Date : 21/03/2017
        /// This function will create the reschedule payment for bank method as output. Here I consider Input grid for schedule dates as well as Payment dates and
        ...
        public static OutputSchedule DefaultSchedule(LoanDetails scheduleInputs)
        {
            ...
            try
            {
                sbTracing.AppendLine("Enter:Inside Business Class CreateScheduleForBankMethod and Method Name DefaultSchedule(LoanDetails scheduleInputs).");
                ...
                sbTracing.AppendLine("Inside CreateScheduleForBankMethod class, and DefaultSchedule() method. Calling Method : principalSerFee.CalculatePrincipalServiceeFee(scheduleInputs.ApplyServiceFeeInterest, principal, scheduleInputs.ServiceFee);");
                ...
                sbTracing.AppendLine("Inside CreateScheduleForBankMethod class, and DefaultSchedule() method. Calling method : orginationFeeForFirstPayment.GetOriginationFeeForFirstPayment(scheduleInputs.OriginationFee, scheduleInputs.OriginationFeePercent, scheduleInputs.OriginationFeeMax, scheduleInputs.OriginationFeeMin, scheduleInputs.OriginationFeeCalculationMethod, principal)");
                ...
                sbTracing.AppendLine("Inside CreateScheduleForBankMethod class, and DefaultSchedule() method. Calling method : sameDayFeeForFirstPayment.GetSameDayFeeForFirstPayment(scheduleInputs.SameDayFee, scheduleInputs.SameDayFeeCalculationMethod, principal);");
                ...
                sbTracing.AppendLine("Inside CreateScheduleForBankMethod class, and DefaultSchedule() method. Calling method : AmountFinanced.GetAmountFinanced(scheduleInputs.LoanAmount, scheduleInputs.AmountFinanced, " +
                ...
                sbTracing.AppendLine("Inside CreateScheduleForBankMethod class, and DefaultSchedule() method. Calling method : CalculateTotalAmount.TotalPayableAmount(scheduleInputs, scheduleOutPut.LoanAmountCalc);");
                double defaultTotalAmountToPay = CalculateTotalAmount.TotalPayableAmount(scheduleInputs, scheduleOutPut.LoanAmountCalc);//, out regularPrincipalOutput);
                ...
                sbTracing.AppendLine("Inside CreateScheduleForBankMethod class, and DefaultSchedule() method. Calling method : ServiceFeeAndServiceFeeInterestPayable.CalculateServiceFeeAndInterestPayable(principalServiceFee, scheduleInputs, scheduleOutPut.LoanAmountCalc);");
                double defaultTotalServiceFeePayable = ServiceFeeAndServiceFeeInterestPayable.CalculateServiceFeeAndInterestPayable(principalServiceFee, scheduleInputs, scheduleOutPut.LoanAmountCalc);//, out regularServiceFeeOutput);
                ...
                {
                    sbTracing.AppendLine("Inside CreateScheduleForBankMethod class, and DefaultSchedule() method. Calling method : ManagementAndMaintenanceFeeCalc.EffectiveDateOfFee(scheduleInputs.ManagementFeeFrequency, scheduleInputs.ManagementFeeDelay, scheduleInputs.InputRecords[0].DateIn, scheduledPayments, mgmtAllPayments);");
                        ...
                        (scheduleInputs.ManagementFeeBasis == -1 && scheduleInputs.ManagementFeePercent == 0))
                    {
                        ...
                        while (managementFeeTableIndex < scheduleOutPut.ManagementFeeAssessment.Count)
                        {
                            ...
                            sbTracing.AppendLine("Inside CreateScheduleForBankMethod class, and DefaultSchedule() method. Calling method : ManagementAndMaintenanceFeeCalc.CalculateFee(scheduleInputs.ManagementFee, " +
                ...
                {
                    sbTracing.AppendLine("Inside CreateScheduleForBankMethod class, and DefaultSchedule() method. Calling method : ManagementAndMaintenanceFeeCalc.EffectiveDateOfFee(scheduleInputs.MaintenanceFeeFrequency, scheduleInputs.MaintenanceFeeDelay, scheduleInputs.InputRecords[0].DateIn, scheduledPayments, allPayments);");
                        ...
                        (scheduleInputs.MaintenanceFeeBasis == -1 && scheduleInputs.MaintenanceFeePercent == 0))
                    {
                        ...
                        while (maintenanceFeeTableIndex < scheduleOutPut.MaintenanceFeeAssessment.Count)
                        {
                            ...
                            sbTracing.AppendLine("Inside CreateScheduleForBankMethod class, and DefaultSchedule() method. Calling method : ManagementAndMaintenanceFeeCalc.CalculateFee(scheduleInputs.MaintenanceFee, " +
                ...
                for (int i = 1; i < scheduleInputs.InputRecords.Count; i++)
                {
                    ...
                    {
                        sbTracing.AppendLine("Inside CreateScheduleForBankMethod class, and DefaultSchedule() method. Calling method : PeriodicInterestRate.GetPeriodicInterestRate(scheduleInputs.DaysInYearBankMethod, scheduleInputs.DaysInMonth, startDate, endDate, Convert.ToDouble(scheduleInputs.InterestRate), scheduleInputs.InputRecords[0].DateIn, scheduleInputs.InterestDelay,false);");
                        ...
                        sbTracing.AppendLine("Inside CreateScheduleForBankMethod class, and DefaultSchedule() method. Calling method : PeriodicInterestAmount.CalculateInterestWithTier(scheduleInputs, startDate, endDate, scheduleInputs.InputRecords[0].DateIn, principal, true,false);");
                    ...
                    else
                    {
                        ...
                        sbTracing.AppendLine("Inside CreateScheduleForBankMethod class, and DefaultSchedule() method. Calling method : PeriodicInterestRate.GetPeriodicInterestRate(scheduleInputs.DaysInYearBankMethod, scheduleInputs.DaysInMonth, startDate, endDate, Convert.ToDouble(scheduleInputs.InputRecords[i].InterestRate), scheduleInputs.InputRecords[0].DateIn, scheduleInputs.InterestDelay,false);");
                        ...
                        sbTracing.AppendLine("Inside CreateScheduleForBankMethod class, and DefaultSchedule() method. Calling method : PeriodicInterestAmount.CalculateInterestWithoutTier(scheduleInputs, startDate, endDate, Convert.ToDouble(scheduleInputs.InputRecords[i].InterestRate), scheduleInputs.InputRecords[0].DateIn, principal, true,false);");
                    ...
                    sbTracing.AppendLine("Inside CreateScheduleForBankMethod class, and DefaultSchedule() method. Calling method : DailyInterestAmount.CalculateDailyInterestAmount(startDate, endDate, interestAccrued, scheduleInputs.InputRecords[0].DateIn, scheduleInputs.InterestDelay);");
                    double dailyInterestAmount = DailyInterestAmount.CalculateDailyInterestAmount(startDate, endDate, interestAccrued, scheduleInputs.InputRecords[0].DateIn, scheduleInputs.InterestDelay, scheduleInputs, true, false);
                    ...
                    if (!scheduleInputs.IsServiceFeeFinanced)
                    {
                        if (scheduleInputs.ApplyServiceFeeInterest == 1 || scheduleInputs.ApplyServiceFeeInterest == 3)
                        {
                            if (string.IsNullOrEmpty(scheduleInputs.InputRecords[i].InterestRate))
                            {
                                sbTracing.AppendLine("Inside CreateScheduleForBankMethod class, and DefaultSchedule() method. Calling method : PeriodicInterestAmount.CalculateInterestWithTier(scheduleInputs, startDate, endDate, scheduleInputs.InputRecords[0].DateIn, principalServiceFee, true,false);");
                            ...
                            {
                                sbTracing.AppendLine("Inside CreateScheduleForBankMethod class, and DefaultSchedule() method. Calling method : PeriodicInterestAmount.CalculateInterestWithoutTier(scheduleInputs, startDate, endDate, Convert.ToDouble(scheduleInputs.InputRecords[i].InterestRate), scheduleInputs.InputRecords[0].DateIn, principalServiceFee, true,false);");
                    ...
                    else if (i != scheduleInputs.InputRecords.Count - 1)
                    {
                        ...
                        {
                            if (scheduleInputs.MinDuration > Models.Constants.MinDurationValue && i == 1)
                            {
                ...
                sbTracing.AppendLine("Inside CreateScheduleForBankMethod class, and DefaultSchedule() method. Calling method : DailyInterestRate.CalculateDailyInterestRate(scheduleInputs.DaysInYearBankMethod, scheduleInputs.DaysInMonth, startDate, endDate, periodicInterestRate, scheduleInputs.InputRecords[0].DateIn, scheduleInputs.InterestDelay,false);");
                    double dailyInterestRate = DailyInterestRate.CalculateDailyInterestRate(scheduleInputs.DaysInYearBankMethod, scheduleInputs.DaysInMonth, startDate, endDate, periodicInterestRate, scheduleInputs.InputRecords[0].DateIn, scheduleInputs.InterestDelay, scheduleInputs, true, false);

                    #region Create default schedule from the bank method.
                    ...
                    scheduleOutPut.Schedule.Add(new OutputGrid
                    {
                        ...
                        SameDayFeePastDue = 0,
                        NSFFeePastDue = (i == 1 ? scheduleInputs.EarnedNSFFee : 0),
                        LateFeePastDue = (i == 1 ? scheduleInputs.EarnedLateFee : 0),
                        TotalPastDue = (i == 1 ? scheduleInputs.EarnedNSFFee + scheduleInputs.EarnedLateFee : 0),
                        ...
                        CumulativeNSFFeePastDue = (i == 1 ? scheduleInputs.EarnedNSFFee : 0),
                        CumulativeLateFeePastDue = (i == 1 ? scheduleInputs.EarnedLateFee : 0),
                        CumulativeTotalPastDue = (i == 1 ? scheduleInputs.EarnedNSFFee + scheduleInputs.EarnedLateFee : 0),
                ...
                //Payment Allocation
                sbTracing.AppendLine("Inside CreateScheduleForBankMethod class, and DefaultSchedule() method. Calling method : ActualPaymentAllocation.AllocationOfFunds(scheduleOutPut.Schedule, scheduleInputs, defaultTotalAmountToPay, defaultTotalServiceFeePayable, originationFee + scheduleInputs.EarnedOriginationFee, scheduleOutPut.LoanAmountCalc, sameDayFee + scheduleInputs.EarnedSameDayFee, scheduleOutPut); ");
                ActualPaymentAllocation.AllocationOfFunds(scheduleOutPut.Schedule, scheduleInputs, defaultTotalAmountToPay, defaultTotalServiceFeePayable, originationFee + scheduleInputs.EarnedOriginationFee, scheduleOutPut.LoanAmountCalc, sameDayFee + scheduleInputs.EarnedSameDayFee, scheduleOutPut);

                //Calculate all the cumulative columns for the bank method.
                sbTracing.AppendLine("Inside CreateScheduleForBankMethod class, and DefaultSchedule() method. Calling method : SumCumulativeAmount(scheduleOutPut.Schedule);");
                ...
                sbTracing.AppendLine("Inside CreateScheduleForBankMethod class, and DefaultSchedule() method. Calling method : CostOfFinance.CalculateCostOfFinance(scheduleInputs, scheduleOutPut.Schedule, scheduleOutPut.OriginationFee, principalAmount);");
                ...
                {
                    sbTracing.AppendLine("Inside CreateScheduleForBankMethod class, and DefaultSchedule() method. Calling method : ServiceFeeAndServiceFeeInterestPayable.GetAccruedServiceFeeInterest(scheduleOutPut.Schedule, scheduleInputs.AccruedServiceFeeInterestDate, scheduleInputs.InputRecords[0].DateIn, scheduleInputs);");
                ...
                {
                    sbTracing.AppendLine("Inside CreateScheduleForBankMethod class, and DefaultSchedule() method. Calling method : ServiceFeeAndServiceFeeInterestPayable.GetInterestAccrued(scheduleOutPut.Schedule, scheduleInputs.AccruedInterestDate, scheduleInputs.InputRecords[0].DateIn, scheduleInputs);");
                ...
                sbTracing.AppendLine("Exist:From Business Class CreateScheduleForBankMethod and Method Name DefaultSchedule(LoanDetails scheduleInputs)");
                return scheduleOutPut;
            }
            catch (Exception ex)
            {
        ...
        /// <summary>
        /// Calculate all the cumulative columns values for the bank method.
        /// </summary>
        ...
        private static void SumCumulativeAmount(List<OutputGrid> outputGrid)
        {
            ...
            try
            {
                sbTracing.AppendLine("Enter:Inside Business Class CreateScheduleForBankMethod and Method Name SumCumulativeAmount(List<OutputGrid> outputGrid).");
                for (int i = 0; i < outputGrid.Count; i++)
                {
                    ...
                    outputGrid[i].TotalPastDue = outputGrid[i].PrincipalPastDue + outputGrid[i].InterestPastDue +
                                                    outputGrid[i].ServiceFeePastDue + outputGrid[i].ServiceFeeInterestPastDue +
                                                    outputGrid[i].OriginationFeePastDue + outputGrid[i].MaintenanceFeePastDue +
                                                    outputGrid[i].ManagementFeePastDue + outputGrid[i].SameDayFeePastDue +
                                                    outputGrid[i].NSFFeePastDue + outputGrid[i].LateFeePastDue;

                    //Cumulative amount past due is added in current past due row
                    outputGrid[i].CumulativePrincipalPastDue = Round.RoundOffAmount((i == 0 ? 0 : outputGrid[i - 1].CumulativePrincipalPastDue) + outputGrid[i].PrincipalPastDue);
                    outputGrid[i].CumulativeInterestPastDue = Round.RoundOffAmount((i == 0 ? 0 : outputGrid[i - 1].CumulativeInterestPastDue) + outputGrid[i].InterestPastDue);
                    outputGrid[i].CumulativeServiceFeePastDue = Round.RoundOffAmount((i == 0 ? 0 : outputGrid[i - 1].CumulativeServiceFeePastDue) + outputGrid[i].ServiceFeePastDue);
                    outputGrid[i].CumulativeServiceFeeInterestPastDue = Round.RoundOffAmount((i == 0 ? 0 : outputGrid[i - 1].CumulativeServiceFeeInterestPastDue) + outputGrid[i].ServiceFeeInterestPastDue);
                    outputGrid[i].CumulativeOriginationFeePastDue = Round.RoundOffAmount((i == 0 ? 0 : outputGrid[i - 1].CumulativeOriginationFeePastDue) + outputGrid[i].OriginationFeePastDue);
                    outputGrid[i].CumulativeMaintenanceFeePastDue = Round.RoundOffAmount((i == 0 ? 0 : outputGrid[i - 1].CumulativeMaintenanceFeePastDue) + outputGrid[i].MaintenanceFeePastDue);
                    outputGrid[i].CumulativeManagementFeePastDue = Round.RoundOffAmount((i == 0 ? 0 : outputGrid[i - 1].CumulativeManagementFeePastDue) + outputGrid[i].ManagementFeePastDue);
                    outputGrid[i].CumulativeSameDayFeePastDue = Round.RoundOffAmount((i == 0 ? 0 : outputGrid[i - 1].CumulativeSameDayFeePastDue) + outputGrid[i].SameDayFeePastDue);
                    outputGrid[i].CumulativeNSFFeePastDue = Round.RoundOffAmount((i == 0 ? 0 : outputGrid[i - 1].CumulativeNSFFeePastDue) + outputGrid[i].NSFFeePastDue);
                    outputGrid[i].CumulativeLateFeePastDue = Round.RoundOffAmount((i == 0 ? 0 : outputGrid[i - 1].CumulativeLateFeePastDue) + outputGrid[i].LateFeePastDue);
                    outputGrid[i].CumulativeTotalPastDue = Round.RoundOffAmount((i == 0 ? 0 : outputGrid[i - 1].CumulativeTotalPastDue) + outputGrid[i].TotalPastDue);
                }
                sbTracing.AppendLine("Exist:From Business Class CreateScheduleForBankMethod and Method Name SumCumulativeAmount(List<OutputGrid> outputGrid)");
            }
            catch (Exception ex)
            {
                LogManager.LogManager.WriteErrorLog(ex);
