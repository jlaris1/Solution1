...
namespace LoanAmort_driver.PeriodBusiness
{
    public class DailyInterestAmount
    {
        ...
        /// <returns></returns>
        public static double CalculateDailyInterestAmount(DateTime startDate, DateTime endDate, double periodicInterestAmount, DateTime loanTakenDate, int interestDelay, LoanDetails scheduleInput, bool isScheduleInput)
        {
            ...
            try
            {
                ...
                sbTracing.AppendLine("Parameter values are : startDate = " + startDate + ", endDate = " + endDate + ", loanTakenDate = " + loanTakenDate + ", interestDelay = " + interestDelay + ",isScheduleInput" + isScheduleInput);
