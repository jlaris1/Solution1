    ...
    public class PrincipalServiceFee
    {
        ...
        public static double CalculatePrincipalServiceeFee(int applyServiceFeeInterest, double loanAmount, double serviceFee)
        {
            ...
            try
            {
                ...
                sbTracing.AppendLine("Exit:From PrincipalServiceFee Class file and Method Name CalculatePrincipalServiceeFee(int applyServiceFeeInterest, double loanAmount, double serviceFee)");
