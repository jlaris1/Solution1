...
namespace LoanAmort_driver.PeriodBusiness
{
    public class CalculatePeriodicInterestRate
    {
        ...
        public static double PeriodicRateCalcWithTier(LoanDetails scheduleInput, DateTime startDate, DateTime endDate, DateTime loanTakenDate, double beginingPrincipal, bool withResidual, bool isScheduleInput, bool isForTotalPayment)
        {
            ...
            try
            {
                sbTracing.AppendLine("Enter: Inside CalculatePeriodicInterestRate Class file and method Name PeriodicRateCalcWithTier(LoanDetails scheduleInput, DateTime startDate, DateTime endDate, DateTime loanTakenDate, double beginingPrincipal, bool withResidual, bool isScheduleInput).");
                ...
                sbTracing.AppendLine("Exit:From CalculatePeriodicInterestRate Class file and method Name PeriodicRateCalcWithTier(LoanDetails scheduleInput, DateTime startDate, DateTime endDate, DateTime loanTakenDate, double beginingPrincipal, bool withResidual, bool isScheduleInput)");
        ...
        public static double PeriodicRateCalcWithoutTier(LoanDetails scheduleInput, DateTime startDate, DateTime endDate, double annualInterestRate, DateTime loanTakenDate, bool withResidual, bool isScheduleInput, bool isForTotalPayment)
        {
            ...
            try
            {
                sbTracing.AppendLine("Enter: Inside CalculatePeriodicInterestRate Class file and method Name PeriodicRateCalcWithoutTier(LoanDetails scheduleInput, DateTime startDate, DateTime endDate, double annualInterestRate, DateTime loanTakenDate, bool withResidual).");
                sbTracing.AppendLine("Parameters are : " + "startDate = " + startDate + "endDate = " + endDate + "annualInterestRate = " + annualInterestRate + "loanTakenDate = " + loanTakenDate + ", withResidual = " + withResidual);
                ...
                sbTracing.AppendLine("Exit:From CalculatePeriodicInterestRate Class file and method Name PeriodicRateCalcWithoutTier(LoanDetails scheduleInput, DateTime startDate, DateTime endDate, double annualInterestRate, DateTime loanTakenDate, bool withResidual, bool isScheduleInput)");
                return periodicInterestRate;
            }
            catch (Exception ex)
            {
